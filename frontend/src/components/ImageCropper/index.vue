          ...
          <div v-show="true" class="vicp-crop-left">
            <div class="vicp-img-container">
              <img ref="img" :src="sourceImgUrl" :style="sourceImgStyle" class="vicp-img" draggable="false"
                @drag="preventDefault" @dragstart="preventDefault" @dragend="preventDefault" @dragleave="preventDefault"
                ...
                @mousemove="imgMove" @mouseup="createImg" @mouseout="createImg">
...
export default {
  ...
  data() {
    ...
    return {
      ...
      sourceImgUrl: '',
      createImgUrl: '',
      sourceImgMouseDown: { on: false, mX: 0, mY: 0, x: 0, y: 0 },
  ...
  computed: {
    ...
    sourceImgMasking() {
      ...
      return { scale, x, y, width: w, height: h }
    },
    sourceImgShadeStyle() {
  ...
  methods: {
    ...
    imgMove(e) {
      ...
      const et = e.targetTouches ? e.targetTouches[0] : e
      const { sourceImgMouseDown: { on, mX, mY, x, y }, scale, sourceImgMasking } = this
      const sim = sourceImgMasking
      const nX = et.screenX
      const nY = et.screenY
      const dX = nX - mX
